  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-6 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        success: "bg-green-600 text-white shadow-sm hover:bg-green-600",
        danger: "bg-red-600 text-white shadow-sm hover:bg-red-600",
        ...
        gradient:
          "bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-white shadow hover:from-purple-600 hover:via-pink-600 hover:to-red-600",
        subtle: "bg-gray-100 text-gray-800 shadow-sm hover:bg-gray-200",
      },
      size: {
